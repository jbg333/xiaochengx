 ...
 * 
 */
public class RedisSentinelClientImpl  extends AbstractRedisClientImpl implements RedisClient{
	
	protected final static Logger logger = LoggerFactory.getLogger(RedisSentinelClientImpl.class);
	...
	public void setJedisPool(JedisSentinelPool pool) {
		this.jedisPool = pool;
	}
