...
import com.jia.code.generator.entity.Column;
import com.jia.code.generator.entity.Table;
import com.jia.code.generator.exception.MyException;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(Map<String, String> column : columns){
			...
			String columnType = columnEntity.getDataType().toLowerCase();
			String attrType="";
